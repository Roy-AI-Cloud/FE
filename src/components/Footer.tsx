        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600 max-w-xs">
              AI 기반 인플루언서 매칭 플랫폼으로 마케팅효과를 극대화하세요.
            </p>
          ...
          {/* 뉴스레터 */}
          <div>
            <h3 className="font-semibold text-gray-900 mb-4">뉴스레터</h3>
            <p className="text-sm text-gray-600 mb-4">
              최신 인플루언서 마케팅 트렌드를 받아보세요.
            </p>
            <div className="flex">
              <input
                type="email"
              ...
              />
              <button className="px-4 py-2 bg-gradient-to-r from-purple-500 to-blue-500 text-white rounded-r-lg hover:from-purple-600 hover:to-blue-600 transition-all">
                구독
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6 text-sm text-gray-500">
              <span>contact@influROI.com</span>
